...
namespace TrailStore.Ordering.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260713165216_AddUserIdToCheckoutWithCheckConstraintForEmail")]
    partial class AddUserIdToCheckoutWithCheckConstraintForEmail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrailStore.Ordering.Domain.Checkout.CheckoutSession", b =>
                {
                    ...
                    b.ToTable("CheckoutSessions", "ordering", t =>
                        {
                            t.HasCheckConstraint("CK_CheckoutSessions_EmailRequiredForUser", "\"UserId\" IS NULL OR \"EmailAddress\" IS NOT NULL");
                        });
                });
