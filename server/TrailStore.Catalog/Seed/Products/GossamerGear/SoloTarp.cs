...
namespace TrailStore.Catalog.Seed.Products.GossamerGear;
...
public static class SoloTarp
{
    ...
    [
        ProductImage.Create(
            Product.Id,
            [
                "/products/gossamer-gear-solo-tarp-1.webp",
