...
namespace TrailStore.Catalog.Seed.Products.Vargo;
...
public static class DigDigTool
{
    ...
    [
        ProductImage.Create(
            Product.Id,
            [
                "/products/vargo-dig-dig-tool-1.webp",
