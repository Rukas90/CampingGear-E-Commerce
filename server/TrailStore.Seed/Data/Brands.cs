...
{
    [SeededEntity] public static readonly Brand Garmin = Brand.Create(
        name: "Garmin",
        slug: "garmin",
    ...
    [SeededEntity] public static readonly Brand Gregory = Brand.Create(
        name: "Gregory",
        slug: "gregory",
        logoUrl: "brands/gregory.webp",
        websiteUrl: "https://www.gregory.com/",
        description:
        "Premier U.S.-based brand specializing in high-performance, comfortable backpacks and travel gear");

    [SeededEntity] public static readonly Brand Durston = Brand.Create(
        name: "Durston",
        slug: "durston",
    ...
    [SeededEntity] public static readonly Brand Zpacks = Brand.Create(
        name: "Zpacks",
        slug: "zpacks",
    ...
    [SeededEntity] public static readonly Brand GossamerGear = Brand.Create(
        name: "Gossamer Gear",
        slug: "gossamer-gear",
    ...
    [SeededEntity] public static readonly Brand PalantePacks = Brand.Create(
        name: "Palante Packs",
        slug: "palante-packs",
    ...
    [SeededEntity] public static readonly Brand HyperliteMountainGear = Brand.Create(
    ...
    [SeededEntity] public static readonly Brand NEMO = Brand.Create(
        name: "NEMO Equipment",
        slug: "nemo-equipment",
    ...
    [SeededEntity] public static readonly Brand GooseFeet = Brand.Create(
        name: "GooseFeet Gear",
        slug: "goosefeet-gear",
    ...
    [SeededEntity] public static readonly Brand Alpenglow = Brand.Create(
        name: "Alpenglow Gear",
        slug: "alpenglow-gear",
    ...
    [SeededEntity] public static readonly Brand Cumulus = Brand.Create(
        name: "Cumulus",
        slug: "cumulus",
    ...
    [SeededEntity] public static readonly Brand Thermarest = Brand.Create(
        name: "Thermarest",
        slug: "thermarest",
    ...
    [SeededEntity] public static readonly Brand Tarptent = Brand.Create(
        name: "Tarptent",
        slug: "tarptent",
    ...
    [SeededEntity] public static readonly Brand EnlightenedEquipment = Brand.Create(
        ...
        description:
        "Premier US-based cottage company specializing in ultralight backpacking quilts, synthetic apparel, and accessories");

    [SeededEntity] public static readonly Brand Deuter = Brand.Create(
        name: "Deuter",
        slug: "deuter",
        logoUrl: "brands/deuter.webp",
        websiteUrl: "https://www.deuter.com/",
        description:
        "Leading manufacturers of backpacks with high-quality standards, from trekking backpacks to daypacks");

    [SeededEntity] public static readonly Brand WarbonnetOutdoors = Brand.Create(
    ...
    [SeededEntity] public static readonly Brand Ombraz = Brand.Create(
        name: "Ombraz Armless",
        slug: "ombraz-armless",
    ...
    [SeededEntity] public static readonly Brand Vargo = Brand.Create(
        name: "Vargo",
        slug: "vargo",
    ...
    [SeededEntity] public static readonly Brand MSR = Brand.Create(
        name: "MSR",
        slug: "msr",
    ...
    [SeededEntity] public static readonly Brand WesternMountaineering = Brand.Create(
        ...
        description:
        "Premier American manufacturer of high-end ultralight sleeping bags, down apparel, and accessories");
}