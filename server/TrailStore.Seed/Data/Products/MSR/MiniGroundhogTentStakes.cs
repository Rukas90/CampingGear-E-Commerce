...
public sealed class MiniGroundhogTentStakes
{
    ...
    [
        ProductImage.Create(
            ...
            urls:      ["/products/msr-mini-groundhog-tent-stakes-1.webp"]),
    ];
