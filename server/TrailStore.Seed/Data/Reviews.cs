...
public static class Reviews
{
    ...
    {
        var voters = faker.PickRandom(Users.All, faker.Random.Int(0, 40)).DistinctBy(c => c.Id).ToList();
    ...
    {
        var basePath = Path.GetDirectoryName(SeedMarker.Reference.Location)!;
